...
<body>
    ...
    <div class="container">
        <div class="row my-3">
            <div class="col-md">
                <h2 class="text-upprtcase text-center fw-bold">Delete Data</h2>
            </div>
        </div>
        <hr>
    </div>
    <div class="add">
        <form action="hapus.php?id=<?= $data['nim'] ?>" method="POST" class="shadow p-3 mb-5 bg-body-tertiary rounded" style="margin:auto;display:flex;flex-direction:column; justify-content:center;align-items:center">
            ...
            <div class="btn d-flex gap-3">
                <button type="submit" class="btn btn-danger d-flex gap-3">Delete</button>
