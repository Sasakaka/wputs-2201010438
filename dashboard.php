...
<body>
    ...
    <div class="container">
        ...
        <hr>
        <div class="main-table shadow p-3 mb-5 my-5 bg-body-tertiary rounded">
            <table class="table table-light">
                <thead>
                    ...
                    <th scope="col">
                        <a href="tambah.php" class="btn btn-success"><i class="bi bi-person-plus-fill"></i>&nbsp;Tambah</a>
                    </th>
                    </tr>
                </thead>
                <tbody class="table-group-divider tx-dark">
                    ...
                    ?>
                        <tr>
                            ...
                            <th scope="col">
                                <a href="ubah.php?id=<?php echo $data_tabel[$i]['nim'] ?>" class="btn btn-primary"><i class="bi bi-pencil-square"></i>&nbsp;Update</a>
                                <a href="hapus.php?id=<?php echo $data_tabel[$i]['nim'] ?>" class="btn btn-danger"><i class="bi bi-person-x"></i>&nbsp;Delete</a>
