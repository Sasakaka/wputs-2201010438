...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="dashboard.php">Dashboard ┃ Data Mahasiswa</a>
    ...
    <div class="container">
        <div class="row my-3">
            <div class="col-md">
                <h2 class="text-upprtcase text-center fw-bold">Update Data</h2>
            </div>
        </div>
        <hr>
    </div>
    <div class="add">
        <form action="ubah.php?id=<?= $data['nim']; ?>" method="POST" class="shadow p-3 mb-5 px-5 bg-body-tertiary rounded" style="margin:auto;display:flex;flex-direction:column; justify-content:center;align-items:center">
